...
All quirk ideas in one table for you to sort. System-specific notes in the right column.

| # | Name | Effect | Notes |
|---|------|--------|-------|
| 1 | **Hot Run** | +1 heat/turn while active | light,  Common |
| 2 | **Greedy** | Energy cost doubled | medium, common  |
| 3 | **Fragile** | All stress thresholds −1 | light, common |
| 4 | **Tricky Boot** | Roll to boot: ≤5 = 2 turns, 6–10 = 1 turn, 11+ = instant | light, common |
...
| 17 | **Overeager** | Resonance >= 5 during failed roll : works anyway then breaks down. | medium, uncommon |
| 18 | **Overload** | 2nd consecutive use: +4 damage, then shuts down. Must reactivate |  Weapon |
| 19 | **Shutdown: Flux Overload** | Shuts down whenever fluxpool > 50%. | medium, uncommon |
...
| 32 | **Last Resort** | Cannot be field repaired again. | Repair |
| 33 | **Rattling Bits** | Something loose / left inside. Rattles. | light, Common |
| 34 | **Stubborn** | All repair times doubled for this system | Repair |
| 35 | **Exotic Parts** | Requires parts one tech level higher than normal to field repair | Repair |
| 36 | **Needs Expert** | -1 to Skill Selector | Repair |
| 37 | **Sparky** | 7 Resonance fills area with sparks, even during repair, might injure mechanic | Repair |
| 38 | **Tied Together** | Two systems share on/off. If one gets disabled / destroyed => other turns off | medium, common |
| 39 | **Thermal Overload** | residual heat: functions at higher level, mech interior fills with smoke | light, rare|
| 40 | **Feedback Siphon** | surge stress: makes system function at higher level | light, rare |
| 41 | **Low Contamination Resistance** | contamination doubled for threshold purposes | medium, uncommon |
| 42 | **Tripping Hazard** | resonance 1: mech falls, must stand back up | Movement |
| 43 | **Target Glitching** | Malus against near OR far targets (one band) | Weapon / Sensor |
| 44 | **Brittle Repairs** | Any amount of Stress increase on the system shuts off | heavy |
| 45 | **Rough Terrain Stall** | Taking hits in rough terrain stops movement | Movement |
| 46 | **Sticky Feed** | Resonance < 3 jams weapon; needs reload to clear | Weapon |
| 47 | **Limited Use** | Limited activations (3 for example) before deactivation; needs field repair to restore | heavy |
...
| 60 | **Glitchy Autoloader** | freq 10: fires twice. Freq 1: jammed, clear requires roll 8+| Weapon |
...
### Light Quirks (d10) — redirect 8→Repair, 9→Medium
...
### Medium Quirks (d10) — redirect 9→Heavy
...
|-----|------|
| 1 | Overload |
| 2 | Shutdown: Flux Overload |
| 3 | Shutdown: Armor Breach |
| 4 | Contamination Leak |
| 5 | Redlining |
| 6 | Berserk |
| 7 | Feedback Storm |
| 8 | Power Vampire |
...
| d10 | Name | Effect |
|-----|------|--------|
| 1 | **Slow Reset** | Reboot takes +1 turn |
| 2 | **Parts Hungry** | Requires 2× parts for any repair on this system |
| 3 | **Fiddly** | +1 penalty die on all repair rolls for this system |
| 4 | **Temporary Fix** | Repairs only last until next facility overhaul; system degrades back to current state |
| 5 | **Special Tooling** | Requires specific tools/workshop; cannot be field-repaired |
| 6 | **Rattling Bits** | Something was left inside. Rattles on movement. −1 stealth. Irritating. |
| 7 | **Stubborn** | All repair times doubled for this system |
| 8 | **Exotic Parts** | Repairs require parts one tech level higher than normal |
| 9 | **Needs Expert** | Requires minimum skill (e.g., Practice ≥ 13) to attempt repair |
| 10 | **Last Resort** | Can only be repaired one more time; after that the system must be replaced |
